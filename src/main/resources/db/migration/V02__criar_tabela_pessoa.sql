...
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) values ('Valdionor Junior Rodrigues', 'Rua do Abacaxi', '10', 'Deus no controle', 'Brasil', '38.400-12', 'São Paulo', 'SP', true);
